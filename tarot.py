...
tarot = {1: "The Magician", 2: "The High Priestess", 3: "The Empress", 4: "The Emperor", 5: "The Hierophant",
         6: "The Lovers", 7: "The Chariot", 8: "Strength",  9: "The Hermit", 10:	"Wheel of Fortune",
...
for each in ["past", "present", "future"]:
    ...
    spread[each] = tarot.pop(np.random.choice(card_left))
for key, value in spread.items():
    print("Your {} is {} card.".format(key, value))
